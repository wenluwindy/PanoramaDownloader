...
在 360*2 云上浏览全景很方便，但要把作品**可靠地落到本地**——完整瓦片、可二次创作的 equirectangular 整图、登录态不丢——往往要折腾半天。
...
### 智能检测
粘贴 360*2 云作品链接，自动识别标题、场景列表、多分辨率瓦片与缩略图。
...
2. **粘贴** 360*2 云作品 HTTPS 链接，点击「分析」  
3. 若提示权限不足，点「登录 360*2 云」在官方页完成登录后重试  
...
┌──────────────────────▼──────────────────────────┐
│                   核心引擎                        │
│  WebView2 加载/捕获  →  Yun360*2 检测  →  下载/拼接  │
